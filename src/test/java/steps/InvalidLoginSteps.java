...
public class InvalidLoginSteps extends CommonMethods {
    ...
    public void system_should_allow_the_user_to_correct_their_input_and_attempt_to_log_in_again() throws InterruptedException {
       // String currentUsernameFieldText = invalidLoginPage.usernameTextField.getText();
        //String currentPasswordFieldText = invalidLoginPage.passwordTextField.getText();
    // Assert.assertEquals("Adimn",currentUsernameFieldText);
     //Assert.assertEquals("Hu@nhrm123",currentPasswordFieldText);
